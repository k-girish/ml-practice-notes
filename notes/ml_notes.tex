...
\begin{itemize}
    \item Random selection of k data points as the cluster centroid
    \item Random partition of data-points into clusters
    \item Farthest distance points -
    \begin{itemize}
        \item First centroid is any random data point
        \item Second centroid is the point which from given data points which is farthest from the first centroid
        \item Similarly, keep choosing point farthest from others for subsequent centroid
    \end{itemize}
\end{itemize}
